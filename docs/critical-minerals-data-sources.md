...
| [UN Comtrade](https://comtradeplus.un.org/) | Official international reporter-partner context for 1962-1992. Keep SITC revisions and product stages separate; use USITC DataWeb as the preferred U.S.-reported verification layer for 1989-1992. The [UNCCD entry](https://www.unccd.int/resources/knowledge-sharing-system/united-nations-commodity-trade-statistics-database-un-comtrade) is a discovery pointer, not the statistical publisher. |
